...
- Node.js process.env (environment variables) — used in: config.js
    [nhttps://nodejs.org/api/process.html](https://nodejs.org/api/process.html)
...
- MongoDB Node.js driver (MongoClient connect pattern) — used in: db.js
    [https://www.mongodb.com/docs/drivers/node/v6.10/connect/connect/](https://www.mongodb.com/docs/drivers/node/v6.10/connect/connect/)
...
- General structure was made in collaboration with fellow student Elouan Van Capellen